			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Thay đổi footer</h3>
							...
							<div class="card-body p-0">
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group">
												<label for="exampleInputText">Nội dung footer:</label>
												<script type="text/javascript">
												  tinymce.init({
													selector: '#noi_dung',
													theme: 'modern',
										...
										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_sua_footer">Sửa footer</button>
										</div>
									</form>
								</div>
								<!-- /.card -->
