		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Sửa menu ngang</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="index.php">Quản trị cửa hàng</a></li>
								<li class="breadcrumb-item active">Quản lý</li>
								<li class="breadcrumb-item active"><a href="index.php?thamso=quan_ly_menu_ngang">Quản lý menu ngang</a></li>
								<?php
									$link_sua="?thamso=sua_menu_ngang&id=".$id."&trang=".$_GET['trang'];
								?>
								<li class="breadcrumb-item active"><a href="<?php echo $link_sua; ?>">Sửa menu ngang <?php echo $ten;?></a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Sửa menu ngang <?php echo $ten;?></h3>
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post">
										...
										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_sua_menu_ngang">Sửa menu ngang</button>
										</div>
									</form>
								</div>
								<!-- /.card -->
