		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Menu ngang</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="index.php">Quản trị cửa hàng</a></li>
								<li class="breadcrumb-item active"><a href="index.php?thamso=menu_ngang">Menu ngang</a></li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text" style="font-weight: bold;"><a href="?thamso=them_menu_ngang" >Thêm menu ngang</a></span>
						...
						<div class="col-md-3 col-sm-6 col-12">
							<div class="info-box">
								<span class="info-box-icon bg-success"><i class="fas fa-bars"></i></span>

								<div class="info-box-content">
									<span class="info-box-text" style="font-weight: bold;"><a href="?thamso=quan_ly_menu_ngang" >Quản lý menu ngang</a></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
