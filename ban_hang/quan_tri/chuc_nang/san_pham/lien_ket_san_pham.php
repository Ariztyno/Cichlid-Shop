					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="index.php?thamso=san_pham">Sản phẩm</a></li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text" style="font-weight: bold;"><a href="?thamso=them_san_pham">Thêm sản phẩm</a></span>
						...
						<div class="col-md-3 col-sm-6 col-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text" style="font-weight: bold;"><a href="?thamso=quan_ly_san_pham" >Quản lý sản phẩm</a></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
