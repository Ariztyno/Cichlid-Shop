					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="index.php?thamso=them_san_pham">Thêm sản phẩm</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post" enctype="multipart/form-data">
										<div class="card-body">
											...
											<div class="form-group">
												<label for="exampleInputText">Danh mục :</label>
												<?php
													$a_1="";
													$a_2="";
												...
												?>
												<select class="form-control select2" style="width: 20%;"  name="danh_muc">
													<?php 
														$tv="select * from menu_doc order by id ";
														$tv_1=mysqli_query($con,$tv);
														$a="";
											...
											<div class="form-group">
												...
												<input  name="gia" value="" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập giá">
											</div>
											<div class="form-group">
												...
												?>
												<select name="noi_bat" class="form-control select2" style="width: 20%;" name="trang_chu">
													<option value="" <?php echo $a_1; ?> >Không</option>
													<option value="co" <?php echo $a_2; ?> >Có</option>
												</select>
											</div>
										...
										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_them_san_pham"> Thêm sản phẩm </button>
										</div>
									</form>
								</div>
								<!-- /.card -->
