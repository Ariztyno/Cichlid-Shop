		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Thay đổi thông tin quản trị</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="index.php">Quản trị cửa hàng</a></li>
								<li class="breadcrumb-item active">Thay đổi</li>
								<li class="breadcrumb-item active"><a href="index.php?thamso=sua_thong_tin_quan_tri">Thay đổi thông tin quản trị</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Thay đổi thông tin quản trị</h3>
							...
							<div class="card-body p-0">
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post">
										<div class="card-body">
											<div class="form-group">
												<label for="exampleInputText">Ký danh :</label>
												<input  name="ky_danh" value="<?php echo $ky_danh; ?>" type="text" class="form-control" id="exampleInputEmail1">
											</div>
											<div class="form-group">
												<label for="exampleInputText">Mật khẩu :</label>
												<input  type="password" name="mat_khau" value="khong_doi" class="form-control" id="exampleInputEmail1"><br>
												<a href="#" class="btn btn-sm btn-warning">- Nếu chỉ muốn đổi ký danh thì chỉ cần sửa ký danh , còn phần mật khẩu thì để nguyên (mật khẩu sẽ không đổi khi gửi biểu mẫu)</a><br><br>
												<a href="#" class="btn btn-sm btn-warning">- Khi sửa thông tin quản trị mà thông tin mật khẩu nhập vào là 'khong_doi' thì thông tin mật khẩu vẫn giữ nguyên (nghĩa là mật khẩu cũ không đổi)</a>
											</div>
										</div>
										<!-- /.card-body -->

										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_sua_thong_tin_quan_tri">Sửa</button>
										</div>
									</form>
								</div>
								<!-- /.card -->
