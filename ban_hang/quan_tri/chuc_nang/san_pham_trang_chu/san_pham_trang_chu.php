		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Sản phẩm trang chủ</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="index.php">Quản trị cửa hàng</a></li>
								<li class="breadcrumb-item active">Sản phẩm</li>
								<li class="breadcrumb-item active"><a href="index.php?thamso=san_pham_trang_chu">Sản phẩm trang chủ</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Sản phẩm trang chủ</h3>
							...
							<div class="card-body p-0">
								...
								<table class="table table-striped projects">
									...
									<tbody>
											...
											while($tv_2=mysqli_fetch_array($tv_1))
											{
												...
												?>
													<tr>
														...
														<td>
															<select class="form-control select2" name="<?php echo $ten_select; ?>" style="width: 40%">
																<option value="" >Không</option>
																<option value="co" selected >Có</option>
															</select>
														</td>
														<td>
															...
															<div class="form-group">
																<input class="form-control" id="exampleInputEmail1" value="<?php echo $sap_xep_trang_chu; ?>" style="width:50px" name="<?php echo $ten_input; ?>" >
																<input  type="hidden" value="<?php echo $id; ?>" name="<?php echo $ten_id; ?>" >
															</div>
														</td>
													</tr>
										...
										<tr>
											<td colspan="5" align="center">
												<button class="btn btn-primary" type="submit" name="bieu_mau_san_pham_trang_chu">Cập nhật</button>
											</td>
										</tr>
										</tr>
										<tr>
											...
											<td colspan="4" align="center">
												<?php 
													...
													{
														$link_phan_trang="?thamso=san_pham_trang_chu&trang=".$i;
														echo "<a href='$link_phan_trang' class='btn btn-primary btn-sm phan_trang' >";
															echo $i;
														echo "</a> ";
													}
												?>
