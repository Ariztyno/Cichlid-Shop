					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="index.php?thamso=quan_ly_menu_ngang">Quản lý menu dọc</a></li>
								<?php
									$link_sua="?thamso=sua_menu_ngang&id=".$id."&trang=".$_GET['trang'];
								?>
								<li class="breadcrumb-item active"><a href="<?php echo $link_sua; ?>">Sửa menu dọc <?php echo $ten;?></a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Sửa menu dọc <?php echo $ten;?></h3>
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post">
										...
										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_sua_menu_doc">Sửa menu dọc</button>
										</div>
									</form>
								</div>
								<!-- /.card -->
