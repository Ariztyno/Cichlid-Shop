					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="index.php?thamso=them_menu_doc">Thêm menu dọc</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Thêm menu dọc</h3>
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post">
										...
										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_them_menu_doc"> Thêm menu </button>
										</div>
									</form>
								</div>
								<!-- /.card -->
