			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Thay đổi banner</h3>
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post" enctype="multipart/form-data">
										<div class="card-body">
											...
											<div class="form-group">
												<label for="exampleInputText">Rộng :</label>
												<input  name="rong" value="<?php echo $rong; ?>" type="text" class="form-control" id="exampleInputEmail1">
											</div>
											<div class="form-group">
												<label for="exampleInputText">Cao :</label>
												<input   name="cao" value="<?php echo $cao; ?>" type="text" class="form-control" id="exampleInputEmail1">
											</div>
										</div>
										<!-- /.card-body -->

										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_sua_banner">Sửa banner</button>
										</div>
									</form>
								</div>
								<!-- /.card -->
