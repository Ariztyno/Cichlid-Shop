...
<?php 
	...
	$tv="select count(id) from san_pham where noi_bat='co' ";
	...
	$tv="select id,ten,gia,hinh_anh from san_pham where noi_bat='co' order by id desc limit $vtbd,$so_dong_tren_mot_trang";
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="index.php?thamso=san_pham_noi_bat">Sản phẩm nổi bật</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
									...
									<tbody>
										...
										<tr>
											<td colspan="4" align="center">
												<button class="btn btn-primary" type="submit" name="bieu_mau_san_pham_noi_bat">Cập nhật</button>
											</td>
										</tr>
										</tr>
										<tr>
