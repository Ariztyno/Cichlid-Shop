		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Thay đổi quảng cáo trái</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="index.php">Quản trị cửa hàng</a></li>
								<li class="breadcrumb-item active">Thay đổi</li>
								<li class="breadcrumb-item active"><a href="index.php?thamso=sua_quang_cao_trai">Thay đổi quảng cáo trái</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Thay đổi quảng cáo trái</h3>
							...
							<div class="card-body p-0">
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group">
												<label for="exampleInputText">Thay đổi quảng cáo trái:</label>
												<script type="text/javascript">
												  tinymce.init({
													selector: '#noi_dung',
													theme: 'modern',
										...
										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_sua_quang_cao_trai">Sửa quảng cáo</button>
										</div>
									</form>
								</div>
								<!-- /.card -->
