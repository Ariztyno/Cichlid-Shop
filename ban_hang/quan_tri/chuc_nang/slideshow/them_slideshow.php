					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="index.php?thamso=them_slideshow">Thêm ảnh slideshow</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Thêm ảnh slideshow</h3>
							...
							<div class="card-body p-0">
								...
								<div class="card card-primary" style="padding: 20px; margin: 20px;">
									...
									<form action="" method="post" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group">
												<label for="exampleInputText">Liên kết :</label>
												<input  name="lien_ket" type="text" class="form-control" id="exampleInputEmail1" >
											</div>
											<div class="form-group">
										...
										<div class="card-footer">
											<button class="btn btn-primary" type="submit" name="bieu_mau_them_slideshow">Thêm ảnh</button>
										</div>
									</form>
								</div>
								<!-- /.card -->
