					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="index.php?thamso=slideshow">Slideshows</a></li>
								<li class="breadcrumb-item active"><a href="index.php?thamso=quan_ly_slideshow">Quản lý slideshow</a></li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Quản lý slideshow</h3>
						...
						<div class="card-tools">
							...
							<div class="card-body p-0">
								...
								<?php 
									...
									$tv="select count(*) from slideshow";
									...
									$tv="select id,hinh,lien_ket from slideshow order by id desc limit $vtbd,$so_dong_tren_mot_trang";
									$tv_1=mysqli_query($con,$tv);
								?>
												...
												?>
													<tr>
														...
														<td class="project-actions text-right">
															<a class="btn btn-info btn-sm" href="<?php echo $link_sua; ?>">
										...
										<tr>
											...
											<td align="center">
												...
												<?php 
													...
													{
														$link_phan_trang="?thamso=quan_ly_slideshow&trang=".$i;
