			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-12">
							<div class="info-box">
								...
								<div class="info-box-content">
									<span class="info-box-text" style="font-weight: bold;"><a href="?thamso=them_slideshow" >Thêm ảnh slideshow</a></span>
						...
						<div class="col-md-3 col-sm-6 col-12">
							<div class="info-box">
								<span class="info-box-icon bg-success"><i class="far fa-image"></i></span>

								<div class="info-box-content">
									<span class="info-box-text" style="font-weight: bold;"><a href="?thamso=quan_ly_slideshow" >Quản lý slideshow</a></span>
								</div>
								<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
