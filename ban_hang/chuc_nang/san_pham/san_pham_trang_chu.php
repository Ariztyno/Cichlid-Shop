                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form>
                                ...
                                <input type="text" name="tu_khoa" placeholder="Nhập sản phẩm cần tìm?">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/banner1.jpg">
                        <div class="hero__text">
                            <span>CICHLID</span>
                            <h2 style="color: white">Dòng cá <br />Nhiệt đới</h2>
                            <p style="color: white">Từ Malawi và Tanganyika</p>
                        </div>
                    </div>
                </div>
            </div>
